...
const prescriptionService = {
    ...
    savePrescription: async (userId, image, medications, allergies, age, conditions, analysisResult) => {
        try {
            const response = await prescriptionAPI.savePrescription(userId, image, medications, allergies, age, conditions, analysisResult);
