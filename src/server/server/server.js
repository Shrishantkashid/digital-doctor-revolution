...
app.post('/api/prescriptions', async (req, res) => {
    try {
        ...
        const prescription = await prescriptionService.savePrescription(userId, image, medications, allergies, age, conditions, isPregnant, isBreastfeeding, analysisResult);
        res.status(201).json({
            success: true,
