...
const DietIcon = () => <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 text-blue-300">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 006-6v-1.5m-6 7.5a6 6 0 01-6-6v-1.5m6 7.5v3H12m-9 0h18M11.25 18.75H12c-.545 0-1.077-.042-1.597-.123C9.742 18.067 8.525 17.5 7.5 16.5m10.5 0c-.545 0-1.077-.042-1.597-.123C14.258 18.067 13.042 17.5 12 16.5m-1.25-6v-4.5m2.5 0v4.5m2.5-4.5v4.5m-7.5-4.5v4.5" />
</svg>;
...
const LandingPage: React.FC<LandingPageProps> = ({ onToolSelect }) => {
    ...
    const translations = {
        ...
        welcomeDescription: 'Your advanced AI-powered health assistant for prescription validation, dosage verification, mental health monitoring, and diet analysis. Upload prescriptions, check for drug interactions, get personalized health insights, and analyze your meals.',
            ...
            <div className="relative z-10 w-full max-w-4xl text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                    ...
                    >
                        <FeatureCard
                            icon={<DietIcon />}
                            title={translations.dietAnalyzer}
                            description="Upload photos of your meals to get nutritional information and personalized healthier alternatives."
                        />
                    </button>
                </div>
            </div>
